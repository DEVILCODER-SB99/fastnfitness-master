...
public class MainActivity extends AppCompatActivity {
    ...
    private StepCountFragment stepCountFragment = null;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        dataList.add(new DrawerItem("Step Count",R.drawable.ic_directions_walk_black_24dp,true));
    ...
    private void showFragment(String pFragmentName, boolean addToBackStack) {
        ...
        else if (pFragmentName.equals(STEPCOUNT)) {
            ft.replace(R.id.fragment_container, getStepFragment(), STEPCOUNT);
        }
    ...
    private StepCountFragment getStepFragment() {
        if (stepCountFragment == null)
            stepCountFragment = (StepCountFragment) getSupportFragmentManager().findFragmentByTag(STEPCOUNT);
        if (stepCountFragment == null) stepCountFragment = StepCountFragment.newInstance(STEPCOUNT, 10);
